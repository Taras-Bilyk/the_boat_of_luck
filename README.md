...
- цікавий фізичниий експеримент і гіпотеза, бо в основі гри як основна мехаіка ігрового логічного двигуна лежить квантова суперпозиція.
- справа в тому що кораблі бота не існують у просторі фізично (їх не існує навіть як електричних зарядів в процесорі, їх немає в коді, про них пк не знає зовсім), але вони існують у часі лише тоді коли користувач торкнувся екрану (лише один такт процесора) а потім знову зникають (і пк навіть не знає що корабель зʼявився на одну мить, бо його не існує взагалі)...
